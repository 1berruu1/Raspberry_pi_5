...
from AuxFuncion import pdfGenfunction, readSerial, pasreData, voltToAirFlow, readSoundSensor, cameraSerial
...
if __name__ == '__main__':
    testdata = PDFdata("SN1234567812",
                       [169.7, 269.8, 469.9, 470.0, 570.1, 670.2, 770.3, 870.4, 970.5, 1070.6, 1170.7, 1270.8,
...
# TESTING PDF GENERATION
    ...
    pdfGenfunction(repo.get_data_by_serial("SN1234567812"))
    # sqlrepo.saveData(PDF)
    print("PDF generated!")
